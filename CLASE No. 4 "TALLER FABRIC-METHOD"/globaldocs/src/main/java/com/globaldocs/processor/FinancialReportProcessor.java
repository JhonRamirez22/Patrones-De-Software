...
public final class FinancialReportProcessor implements DocumentProcessor {

    private final DocumentFormat format;
    private final String countryCode;

    public FinancialReportProcessor(DocumentFormat format, String countryCode) {
    ...
    public String process(String fileName, String content) {
        ...
        return String.format("[CO:%s] Processed Financial Report '%s' (%d bytes) | Financial audit: COMPLIANT",
