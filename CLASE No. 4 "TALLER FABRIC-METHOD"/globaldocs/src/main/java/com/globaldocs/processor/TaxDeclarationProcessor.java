...
public final class TaxDeclarationProcessor implements DocumentProcessor {

    private final DocumentFormat format;
    private final String countryCode;

    public TaxDeclarationProcessor(DocumentFormat format, String countryCode) {
    ...
    public String process(String fileName, String content) {
        ...
        return String.format("[CO:%s] Processed Tax Declaration '%s' (%d bytes) | Tax compliance: VALIDATED",
