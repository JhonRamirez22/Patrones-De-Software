...
public final class LegalContractProcessor implements DocumentProcessor {

    private final DocumentFormat format;
    private final String countryCode;

    public LegalContractProcessor(DocumentFormat format, String countryCode) {
    ...
    public String process(String fileName, String content) {
        ...
        return String.format("[CO:%s] Processed Legal Contract '%s' (%d bytes) | Legal validation: PASSED",
